...
function updateSusLayer(markerData, markerGroup) {
  geojsonData.features.forEach(feature => {
      ...
      if (id in markerData) {
        ...
        popupContent += `<img src="${GHP_ROOT}/assets/2021/spadove/${id}.png" style="width:500px; height:auto;" />`; // needs fixing
        popupContent += `<br><a href="${GHP_ROOT}/assets/2021/spadove/${id}.html" target="_blank">Виж секции</a>`; // needs fixing
